    ...
    class PaymentMethodDetails(StripeObject):
        ...
        class Card(StripeObject):
            ...
            class Wallet(StripeObject):
                ...
                """
                The type of the card wallet, one of `apple_pay`, `google_pay`, or `link`. An additional hash is included on the Wallet.js subhash with a name matching this value. It contains additional information specific to the card wallet type.
                """
                _inner_class_types = {
                    "apple_pay": ApplePay,
