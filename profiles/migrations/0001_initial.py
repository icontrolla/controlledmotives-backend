# Generated by Django 5.2 on 2025-06-27 21:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft_metadata', models.JSONField(blank=True, help_text='Metadata of the NFT', null=True)),
                ('copyright_hash', models.CharField(blank=True, max_length=255, null=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drawing_artworks_created', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_artwork', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_flowered_set', to='profiles.artgallery')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nft_metadata', models.JSONField(blank=True, help_text='Metadata of the NFT', null=True)),
                ('copyright_hash', models.CharField(blank=True, max_length=255, null=True)),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='virtualart', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Fine Art',
                'verbose_name_plural': 'Fine Arts',
